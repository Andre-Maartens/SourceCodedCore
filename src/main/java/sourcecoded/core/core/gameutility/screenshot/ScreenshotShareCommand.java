...
public class ScreenshotShareCommand extends CommandBase {
    ...
    @Override
    public void processCommand(ICommandSender sender, final String[] args) throws WrongUsageException {
                        ...
                        if (Minecraft.getMinecraft().thePlayer != null) {
                            if (response != null) {
                                ...
                                if (success) {
                                    ...
                                    IChatComponent chat = IChatComponent.Serializer.jsonToComponent(str);
