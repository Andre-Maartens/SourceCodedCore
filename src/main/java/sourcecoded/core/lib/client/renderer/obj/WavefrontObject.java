...
//Temporary port of the 1.7 Wavefront OBJ code until Forge gets it merged. Credit to forge team
public class WavefrontObject {
    ...
    public void renderAll()
    {
        ...
        if (currentGroupObject != null)
        {
            wr.startDrawing(currentGroupObject.glDrawingMode);
        }
        else
        {
    ...
    public void tessellateAll(Tessellator tessellator)
    {
        ...
        {
            groupObject.render(tessellator, tessellator.getWorldRenderer());
        }
    }
