package sourcecoded.core.lib.config;
...
public class SCConfigManager {
    ...
    public static enum Properties {
        ...
        CRASH(Categories.CRASHLOG, "crash_handler", "Should crash reports automatically be caught and uploaded to GitHub Gists (should always true unless you're one of those paranoid people who believes in the Illuminati and aliens from planet zorg)", true),
        ;
